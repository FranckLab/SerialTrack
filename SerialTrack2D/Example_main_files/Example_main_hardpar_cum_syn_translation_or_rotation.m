...
BeadPara.minSize = 2;           % Minimum area of a single particle [px]
BeadPara.maxSize = 20;          % Maximum area of a single particle [px]
...
minTrajSegLength = 0;    % the minimum length of trajectory segment that will be extrapolated [px]
