...
% Syn or Exp:           exp  
% Deformation mode:     lung air flow
%
% ===================================================
...
MPTPara.xstep = 0.0408;     % unit: mm/px
MPTPara.tstep = 1.6e-4;     % unit: s
...
BeadPara.minSize = 2;           % Minimum radius of a single particle [px^2]
BeadPara.maxSize = 200;         % Maximum radius of a single particle [px^2]
...
MPTPara.n_neighborsMin = 25;     % Min # of neighboring particles
MPTPara.locSolver = 2;           % Local solver: 1-topology-based feature; 2-histogram-based feature first and then topology-based feature;
