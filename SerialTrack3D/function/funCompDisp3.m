function [track_A2B, u_A2B] = funCompDisp3(parCoordA, parCoordB, matches_A2B, outlrThres)
%FUNCTION [track_A2B, u_A2B] = funCompDisp3(parCoordA, parCoordB, matches_A2B, removeOutlierOrNot)
% Objective: To compute tracked displacements from matched particle pairs
% ---------------------------------------------------
% 
...
%           u_A2B                   Tracked displacement components [n x 3]
% 
% ---------------------------------------------------
% Author: Jin Yang
...
try
    if outlrThres > 0 % Remove Outliers
       [track_A2B] = removeOutlierTPT(parCoordA,parCoordB,track_A2B,outlrThres);
    end
catch
end
